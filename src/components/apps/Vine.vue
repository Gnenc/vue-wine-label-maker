<template>
  <div class="container">
        ...
        <component :is="selected">
          <svg class="winebottle" aria-labelledby="title" xmlns="http://www.w3.org/2000/svg" viewBox="0 155 140 300">
            ...
            <g>
              ...
              <image class="bkimg" x="0" y="293" width="138" height="100" xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="'https://s3-us-west-2.amazonaws.com/s.cdpn.io/28963/' + wineImg + '.png'" :style="{opacity: imgOpacity }"></image>
            </g>
    ...
    <aside>
      ...
      <input v-model="label" maxlength="18" placeholder="Label Name">
      <div class="button-row">
        <h4>Color</h4>
        <button @click="selected ='Black', labelColor = '#000000'">Black Label</button>
        <button @click="selected ='White', labelColor = '#ffffff'">White Label</button>
...
import Floor1 from "../floors/Floor1.vue";
import Floor2 from "../floors/Floor2.vue";
import Floor3 from "../floors/Floor3.vue";
